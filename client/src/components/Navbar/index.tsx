...
import { Jogadores, Perfil, Sair } from '../icons/notBold';
import { BoldJogadores, BoldPerfil } from '../icons/bold';
  ...
  return (
    <>
      <SidebarContainer isExpanded={isExpanded} onClick={toggleNavbar}>
        <TopIconContainer isExpanded={isExpanded}></TopIconContainer>

        {isExpanded && <Seta onClick={collapseNavbar} />}
      ...
      {isModalOpen && <ModalLogout onClose={handleModalClose} />}
    </>
  );
};
